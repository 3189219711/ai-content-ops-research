...
> 拆 5 个抖音 AI 萌宠账号，每个账号写 2 个模块（① 账号特点与爆款公式 ② 爆款内容清单配截图），文末统一汇总「我们可以复刻的东西」与「侵权风险」两个跨账号对比模块。
...
- 平台：抖音
- 主页链接：<https://v.douyin.com/p2oNHdVsNMQ/>
- 抖音号：61189914847
- 粉丝量：1.0 万
- 获赞量：15.8 万
...
- **音乐版权**：抖音平台 BGM 授权范围只限抖音站内，跨平台发到自有微信小程序不生效；音频只能用「商用授权音乐库」或「自有音频（翻唱 / AI 生成 / 原创）」。
- **角色形象权**：各账号萌宠都是原创角色，别 1:1 复制，设计独立动物。
- **声音 / 表演**：别克隆他人音色，用自己翻唱或 AI 配音 / 歌声。
- **视频搬运**：别原样搬，换角色 + 换 BGM + 换场景 + 改文案。
