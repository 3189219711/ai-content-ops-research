# -*- coding: utf-8 -*-
"""把 玄学命理类账号单拆汇总.md 转成单文件 HTML（图片 base64 内嵌）。"""
import os, re, html, base64

SRC = r"D:/TOJOY/AI内容运营开源项目调研/账号单拆/玄学命理类账号单拆汇总.md"
BASE = os.path.dirname(SRC)
OUT = r"D:/TOJOY/AI内容运营开源项目调研/账号单拆/玄学命理类账号单拆汇总.html"
