# -*- coding: utf-8 -*-
"""把 情感鸡汤类账号单拆汇总.md 转成单文件 HTML（图片 base64 内嵌）。"""
import os, re, html, base64

SRC = r"D:/TOJOY/AI内容运营开源项目调研/账号单拆/情感鸡汤类账号单拆汇总.md"
BASE = os.path.dirname(SRC)
OUT = r"D:/TOJOY/AI内容运营开源项目调研/账号单拆/情感鸡汤类账号单拆汇总.html"
...
<title>情感鸡汤类账号单拆汇总</title>
<style>""" + CSS + """</style>
</head>
<body>
<div class="hero">
  <h1>情感鸡汤类账号单拆汇总</h1>
  <p>2 个对标账号 · 爆款公式与作品清单 · 复刻对比与侵权风险 · 内部参考</p>
</div>
